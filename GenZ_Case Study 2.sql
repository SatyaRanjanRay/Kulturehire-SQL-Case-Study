...
-- Question 10: Give a Detailed Split of the GenZ preferences to work with Teams, 
...
-- Question 12: Give a detailed breakdown of worklikelihood3years for each state in India
...
-- Question 13: What is the average starting salary expectation at 3 year for each gender
...
-- Question 14: What is the average starting salary expectation at 5 year for each gender
...
-- Question 15: What is the average higher bar salary expectation at 3 year for each gender
...
-- Question 16: What is the average higher bar salary expectation at 5 year for each gender
...
-- Question 17: What is the average starting salary expectations at 3 year for each gender and each state
...
-- Question 18: What is the average starting salary expectations at 5 year for each gender and each state
...
-- Question 19: What is the average higher bar salary expectations at 3 year for each gender and each state
...
-- Question 20: What is the average higher bar salary expectations at 5 year for each gender and each state
...
-- Question 21: Give an detailed breakdown of the possibility of GenZ working for an org if the 'mission is misaligned' for each state in india
