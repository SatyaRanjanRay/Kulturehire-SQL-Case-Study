...
-- Question1: How many Males have responded from India

SELECT COUNT(*) AS Male_Respondents
FROM personalized_info 
WHERE Gender like "Male%" AND CurrentCountry="India";  

-- Question2: How many Females have responded from India
SELECT COUNT(*) AS Female_Respondents 
FROM personalized_info 
WHERE Gender like "Fe%" AND CurrentCountry="India";

-- Question3: How many GenZ are influenced by their parents in regards to their career choices from India

SELECT COUNT(*) AS Genz_aspirants
FROM learning_aspirations
WHERE CareerInfluenceFactor="My Parents";

-- Question4: How many Female GenZ are influenced by their parents in regards to their career choices from India
...
-- Question5: How many Male GenZ are influenced by their parents in regards to their career choices from India
...
-- Question6: How many Male and Female GenZ are influenced by their parents in regards to their career choices from India
...
-- Question7: Hoew many GenZ are influenced by Social Media and Influencers together from India
...
-- Question8: How many Gen-Z are infuenced by Social Media and Influencers together, display for Male and Female seperately from India
